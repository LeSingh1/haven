...
export default function LandingPage() {
  return (
    <main className="relative min-h-dvh overflow-hidden">
      ...
      <section className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pt-28 pb-16 text-center sm:pt-36">
        {/* Eyebrow */}
        <div className="mb-8">
        ...
        {/* Hero headline */}
        <h1 className="max-w-4xl text-balance text-5xl font-bold leading-[1.05] tracking-tight text-text sm:text-6xl md:text-7xl">
        ...
        {/* Subhead */}
        <p className="mt-8 max-w-2xl text-balance text-base leading-relaxed text-textdim sm:text-lg">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <Link
            href="/finder"
            className="btn-ghost inline-flex min-h-[52px] items-center justify-center rounded-xl px-7 text-sm font-semibold"
          >
            Browse listings
          </Link>
        </div>
        ...
        {/* Footer note */}
        <p className="mt-16 max-w-md text-xs leading-relaxed text-textdim/70">
